...
| Category | Skills |
|---|---|
| **Security Tools** | Wireshark, Splunk / Chronicle (SIEM), Linux, SQL, Nmap |
| **Concepts & Frameworks** | NIST framework, CIA Triad, Incident Response Lifecycle, Risk Management, Access Control |
| **Programming/Querying** | Python (basic scripting), SQL |
| **Networking & OS** | TCP/IP, Linux command line, network protocols |
| **Governance, Risk & Compliance** | NIST CSF, PCI DSS, GDPR, SOC Type 1 & 2, Internal IT Audit, Risk Assessment, Gap Analysis, Asset Management |
